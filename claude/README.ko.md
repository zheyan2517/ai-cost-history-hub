...
[웹사이트](https://local.github.io/claude-code-history-viewer/) · [다운로드](https://github.com/local/claude-code-history-viewer/releases) · [버그 제보](https://github.com/local/claude-code-history-viewer/issues)
...
| Windows (x64) | [`.exe`](https://github.com/local/claude-code-history-viewer/releases/latest) / [`.zip` (포터블)](https://github.com/local/claude-code-history-viewer/releases/latest) |
...
```bash
brew install local/tap/cchv-server   # 또는: curl -fsSL https://...install-server.sh | sh
...
[Releases](https://github.com/local/claude-code-history-viewer/releases)에서 다운로드하세요.
...
| 업데이트 오류 | 자동 업데이트 실패 시 [Releases](https://github.com/local/claude-code-history-viewer/releases)에서 수동 다운로드 |
