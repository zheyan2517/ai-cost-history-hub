...
[網站](https://local.github.io/claude-code-history-viewer/) · [下載](https://github.com/local/claude-code-history-viewer/releases) · [回報問題](https://github.com/local/claude-code-history-viewer/issues)
...
| 平台 | 下載 |
|----------|----------|
| macOS (通用版) | [`.dmg`](https://github.com/local/claude-code-history-viewer/releases/latest) |
| Windows (x64) | [`.exe`](https://github.com/local/claude-code-history-viewer/releases/latest) / [`.zip` (可攜版)](https://github.com/local/claude-code-history-viewer/releases/latest) |
...
從 [Releases](https://github.com/local/claude-code-history-viewer/releases) 下載。
...
| 更新問題 | 如果自動更新失敗，請從 [Releases](https://github.com/local/claude-code-history-viewer/releases) 手動下載 |
