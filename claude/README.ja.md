...
[ウェブサイト](https://local.github.io/claude-code-history-viewer/) · [ダウンロード](https://github.com/local/claude-code-history-viewer/releases) · [バグ報告](https://github.com/local/claude-code-history-viewer/issues)
...
| Windows (x64) | [`.exe`](https://github.com/local/claude-code-history-viewer/releases/latest) / [`.zip` (ポータブル)](https://github.com/local/claude-code-history-viewer/releases/latest) |
...
[Releases](https://github.com/local/claude-code-history-viewer/releases)からダウンロード。
...
| 更新の問題 | 自動更新が失敗した場合、[Releases](https://github.com/local/claude-code-history-viewer/releases)から手動ダウンロード |
