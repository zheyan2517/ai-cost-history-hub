...
[官网](https://local.github.io/claude-code-history-viewer/) · [下载](https://github.com/local/claude-code-history-viewer/releases) · [报告问题](https://github.com/local/claude-code-history-viewer/issues)
...
| 平台 | 下载 |
|----------|----------|
| macOS (通用) | [`.dmg`](https://github.com/local/claude-code-history-viewer/releases/latest) |
| Windows (x64) | [`.exe`](https://github.com/local/claude-code-history-viewer/releases/latest) / [`.zip` (便携版)](https://github.com/local/claude-code-history-viewer/releases/latest) |
...
从 [Releases](https://github.com/local/claude-code-history-viewer/releases) 下载。
...
| 更新问题 | 如果自动更新失败,请从 [Releases](https://github.com/local/claude-code-history-viewer/releases) 手动下载 |
